class Dashboard::CoffeeShopsController < ApplicationController
  ...
  def coffee_shop_params
    params.require(:coffee_shop).permit(:name, :shop_url, :address, :tell, :access, :business_start_hour, :business_end_hour, :instagram_url, :instagram_spot_url, :municipalitie_id, :slack_time_start, :slack_time_end, {:search_category_ids => []}, images: [])
  end
